                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">COTIZACIÓNES</h2>
                                <section id="formu" style='width:30%'>
                                    ...
                                    <form role="form" action="exportarcotizacion.php" method="POST">
                                ...
                                <div class="panel-body">
                                    <?php if ($empresa  == "todasempresas"){ ?>
                                        <form role="form" action="reporte.php" method="POST">
                                            ...
                                            <input type="hidden" value="Reporte Cotizaciones2 <?php echo $_POST['fecha1'] ?> - <?php echo $_POST['fecha2'] ?>.xls" name="repor">
                                            <input type="submit" value="Exportar a Excel" class="btn btn-primary btn-lg" name="generar_reportee">
                                        </form> 
                                    <?php };?><?php if ($empresa  != "todasempresas"){ ?>
                                        <form role="form" action="reporte.php" method="POST">
                                            ...
                                            <input type="hidden" value="Reporte Cotizaciones <?php echo $_POST['fecha1'] ?> - <?php echo $_POST['fecha2'] ?>.xls" name="repor">
