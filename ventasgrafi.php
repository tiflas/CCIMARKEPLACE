                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-9" aria-controls="submenu-9"><i class="fas fa-fw fa-chart-pie"></i> Graficos</a>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">INFORMACIÓN DE VENTAS</h2>
                                <section id="formu" style='width:30%'>
                                    <form role="form" action="" method="POST"  target="_blank">
                                        <label >Seleccionar Empresa Proveedor MAX 10:</label>
                                        <div style='overflow: auto;width: 90%;height: 200px;'>
                                            <?php
                                                $empre = consulta::empreAllprove();
                                                foreach ($empre as $row1) {
                                                    echo" <input type='checkbox' name='idempresa[]' value='".$row1["IDEMPRESA"]."'>".$row1["NOMBFANTASIA"]."<br>";
                                                } 
                                            ?>
                                        </div><br>
                                        <section id="formu2" style='width:40%'>
                                        ...
                                        <section id="formu2" style='width:70%'>
                                            <input type="submit" onclick='this.form.action="Reportes_graficos/examples/graficoventa/graficoventas.php";' value="Generar Grafica pie-legend" class="btn btn-primary btn-lg"><br><br>
                                            <input type="submit" onclick='this.form.action="Reportes_graficos/examples/graficoventa/graficoventasbasic.php";' value="Generar Grafica pie-basic" class="btn btn-primary btn-lg"><br><br>
                                            <input type="submit" onclick='this.form.action="Reportes_graficos/examples/graficoventa/graficoventas3d.php";' value="Generar Grafica pie-3D" class="btn btn-primary btn-lg">
                                        </section>
                                    </form> 
                                </section> 
                                <div class="row"></div>  
                                ...
                                <div class="panel-body">
                                    ...
                                    <?php if ($empresa  == "todasempresas"){ ?>
                                        <form role="form" action="reporte.php" method="POST">
                                            ...
                                            <input type="hidden" value="Centros de costos<?php echo $_POST['fecha1'] ?> - <?php echo $_POST['fecha2'] ?>.xls"   name="repor">
