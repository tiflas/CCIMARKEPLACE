                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-10" aria-controls="submenu-10"><i class="fas fa-fw fa-inbox"></i>Errores Maestrolog</a>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">ERRORES MAESTROLOG</h2>
                                <section id="abrir" style='position:relative;display:none'>
                                    <?php
                                        ...
                                        $fecha3    = $_POST['fecha1'];
                                        $fecha4    = $_POST['fecha2']; 
                                        $tipom     = $_POST['tipomaes'];
                                        $tipoma    = $uno.$tipom.$dos;      
                                    ?>
                                </section> 
                                    <?php 
                                        if($tipom  == ""){ echo "";}else{ echo "<h3>Resultado de : ".$tipom."  Fecha: $fecha1 - $fecha2</h3><br> "; }
                                    ?>   
                                </section>
                                <section id="formu" style='width:30%'>
                                    <form role="form" action="maestrolog.php" method="POST">
                                        <label >Seleccionar Tipo Mestro:</label>
                                        <select class='form-control' name='tipomaes'>
                                                <option value="all">TODOS LOS MAESTROS</option>
                                                <option value="OrdenCompra">Ordenes de Compra</option> 
                                ...
                                <div class="panel-body">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables1">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Dato Principal GC</th>
                                                    <th>Datos RespuestaAR</th>
                                                    <th>Datos Entrada</th>
                                                    <th>Accion</th> 
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                    if(($tipom  == "seleccionar") || ($tipoma == "'%%'")){
                                                        ...
                                                        $posicion = consulta::maestrologoall($fecha1,$fecha2);
                                                            foreach ($posicion as $row) {
                                                                $xml1 = str_replace('<','{',$row["InMalo_DatosEntrada"]);
                                                                $xml2 = str_replace('>','}',$xml1);
                                                            echo "
                                                                <tr>
                                                                    <td>".$row["InMaLo_TipoMaestro"]."</td>                                  
                                                                    <td>".$row["InMaLo_FechaProcesado"]."</td>
                                                                    <td>".$row["InMaLo_ResultadoProceso"]."</td>
                                                                    <td>".$row["InMaLo_DatoPrincipal"]."</td> 
                                                                    <td>".$row["InMaLo_DatoPrincipalGC"]."</td>
                                                                    <td>".$row["InMaLo_DatoRespuestaAR"]."</td>
                                                                    <td>".$xml2."</td>
                                                                    <td>
                                                                    <a href=''><img style='width: 50px;height: 70px' src='images/enviar.png'/></a>
                                                                    </td>
                                                                </tr>";
                                                            }
                                                    }elseif($tipom  == "Ofertas"){
                                                        $posicion = consulta::maestrologo($tipoma,$fecha1,$fecha2);
                                                            foreach ($posicion as $row) {
                                                            echo "
                                                                <tr>
                                                                    <td>".$row["InMaLo_TipoMaestro"]."</td>                                  
                                                                    ...
                                                                    <td>".$row["InMaLo_DatoPrincipalGC"]."</td>
                                                                    <td>".$row["InMaLo_DatoRespuestaAR"]."</td>
                                                                    <td>".$row["InMalo_DatosEntrada"]."</td>
                                                                    <td>
                                                                    <a href='../ccimarketplace/Controller/maestrolog.controller.php?ui=".$row["InMaLo_DatoPrincipalGC"]."&acc=ofe'><img style='width: 50px;height: 70px' src='images/enviar.png'/></a>
                                                                    </td>
                                                                </tr>";
                                                            }
                                                    }elseif($tipom  == "Cotización"){
                                                        $posicion = consulta::maestrologo($tipoma,$fecha1,$fecha2);
                                                        foreach ($posicion as $row) {
                                                            $xml1 = str_replace('<','{',$row["InMalo_DatosEntrada"]);
                                                            $xml2 = str_replace('>','}',$xml1);
                                                            echo "
                                                                <tr>
                                                                    ...
                                                                    <td>".$xml2."</td>
                                                                    <td>
                                                                    <a href='../ccimarketplace/Controller/maestrolog.controller.php?ui=".$xml2."&acc=coti'><img style='width: 50px;height: 70px' src='images/enviar.png'/></a>
                                                                    </td>
                                                                </tr>";
                                                        }
                                                    }else{
                                                        $posicion1 = consulta::maestrologo($tipoma,$fecha1,$fecha2);
                                                        foreach ($posicion1 as $row1) {
                                    ...
                                    <?php if ($tipom == "all"){ ?>
                                        <form role="form" action="reporte.php" method="POST">
                                            ...
                                            <input type="hidden" value="Errores Maestrolog all <?php echo $_POST['fecha1'] ?>-<?php echo $_POST['fecha2'] ?>.xls"  name="repor">
                                            <input type="submit" value="Exportar a Excel" class="btn btn-primary btn-lg" name="generar_reporte">
                                        </form>
                                    <?php };?><?php if ($tipom != "all"){ ?>
                                        <form role="form" action="reporte.php" method="POST">
                                            <input type="hidden" value="<?php echo $_POST['fecha1'] ?>" name="fecha1">
                                            <input type="hidden" value="<?php echo $_POST['fecha2'] ?>" name="fecha2">
                                            <input type="hidden" value="<?php echo $tipoma ?>" name="tipomaestro">
                                            <input type="hidden" value="Errores Maestrolog <?php echo $_POST['fecha1'] ?>-<?php echo $_POST['fecha2'] ?>.xls"  name="repor">
                                            <input type="submit" value="Exportar a Excel" class="btn btn-primary btn-lg" name="generar_reporte">
                                        </form>
                                    <?php };?>                            
                                </div>
