                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">PROVEEDORES POR INSUMO</h2>
                                ...
                                <section id="formu" style='width:30%'>
                                    <form role="form" action="proveeinsumo.php" method="POST">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                            ...
                                            <tbody>
                                                <?php
                                                    if(($arti== "'%%'")  ||  ($arti1 == "'%%'")  ||  ($arti2  == "'%%'")  || ($arti3 == "'%%'")){
                                                        ...
                                                        $posicion = consulta::consinsumoprovee($fechapri,$fechase,$arti,$arti1,$arti2,$arti3);
                                    ...
                                    <form role="form" action="reporte2.php" method="POST">
                                        ...
                                        <input type="hidden" value="Reporte Proveedor-insumo <?php echo $articulo; ?>-<?php echo $_POST['fecha1'] ?>-<?php echo $_POST['fecha2'] ?>.xls"  name="repor">
