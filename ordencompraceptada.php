                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">ORDENES DE COMPRAS ACEPTADAS</h2>
                                <section id="formu" style='width:30%'>
                                    <form role="form" action="ordencompraceptada.php" method="POST">
                                        <label>Nombre de empresa</label>
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"></span>
                                            <input type="text" placeholder="Buscar empresa" name="busempresa" class="form-control">
                                        </div>
                                        <input type="submit" value="Buscar" class="btn btn-primary btn-lg"><br>
                                            <?php
                                                echo "<section style='position:relative;display:none'>";  
                                                    $busempresa   = $_POST['busempresa'];
                                                echo "</section>";
                                                    if($busempresa  == ""){
                                                        echo"";
                                                    }else{
                                                        echo "
                                                        <br>
                                                        <label style='color:red'> Resultado de busqueda de empresa</label>
                                                        <select class='form-control' name='idempre'>
                                                            <option value='todasempresas'>TODAS LAS EMPRESAS</option>";
                                                            
                                                                $empre = consulta::empreAllprovebuscar($busempresa);
                        ...
                        <!-- Advanced Tables -->
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Tabla de Ordenes de compra aceptadas
                                </div>  
                                ...
                                <div class="panel-body">
                                            ...
                                            <tbody>
                                                <?php  
                                                    if($empresa  == "todasempresas"){
                                                        ...
                                                        $posicion = consulta::OC_aceptadas($empresa,$fechapri,$fechase);
                                                        foreach ($posicion as $row) {
                                                        echo "
                                                            <tr>                                                    
                                                                <td>".$row["ocidempresa"]."</td>
                                    ...
                                    <?php if ($empresa  == "todasempresas"){ ?>
                                        <form role="form" action="reporte.php" method="POST">
                                            ...
                                            <input type="hidden" value="Reporte OC Aceptada todas las empresas Fecha <?php echo $_POST['fecha1'] ?> - <?php echo $_POST['fecha2'] ?>.xls"  name="repor">
                                    ...
                                    <?php };?><?php if ($empresa  != "todasempresas"){ ?>
                                        <form role="form" action="reporte.php" method="POST">
                                            ...
                                            <input type="hidden" value="Reporte OC Aceptada Fecha <?php echo $_POST['fecha1'] ?> - <?php echo $_POST['fecha2'] ?>.xls"  name="repor">
                                            <input type="submit" value="Exportar a Excel" class="btn btn-primary btn-lg" name="generar_reporteempre">
                                        </form>
                                    <?php };?>                            
                                </div>
                            </div>
