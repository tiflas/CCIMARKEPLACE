                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">RECEPCIONES</h2>
                                <section id="formu" style='width:30%'>
                                    <form role="form" action="recepcion.php" method="POST">
                                        <label >Seleccionar Empresa:</label>
                                        <select class='form-control' name='idempre'>
                                            <option value="todasempresas">TODOS LAS EMPRESAS</option>
                                            <?php
                                            ...
                                            <tbody>
                                                <?php
                                                    if($empresa  == "todasempresas"){
                                                        $posicion = consulta::recepciones($fecha1,$fecha2);
                                                        ...
                                                        $posicion1 = consulta::recepciones2($fecha1,$fecha2,$empresa);
                                                        foreach ($posicion1 as $row1) {
                                                            echo "
                                                                <tr>                                                    
                                                                    <td>".$row1["Empresa"]."</td>                                                 
                                                                    <td>".$row1["NumOrdenCompra"]."</td>
                                                                    <td>".$row1["Proveedor"]."</td>
                                                                    <td>".$row1["Fechaenvioprov"]."</td> 
                                                                    <td>".$row1["TotalNetoOC"]."</td>
                                                                    <td>".$row1["IvaOC"]."</td>
                                                                    <td>".$row1["PartidaPresupuestal"]."</td>
                                                                    <td>".$row1["NumDocRecepcion"]."</td> 
                                                                    <td>".$row1["MontoNetoRecibido"]."</td> 
                                                                    <td>".$row1["IvaRecibido"]."</td> 
                                                                    <td>".$row1["Total"]."</td>
                                                                    <td>".$row1["FechaRecepcion"]."</td>
                                                                    <td>".$row1["estado"]."</td>
                                                                    <td>".$row1["comprobantedeingreso"]."</td>
                                                                    <td>".$row1["estadoocre"]."</td>
                                                                    <td>".$row1["estadooc"]."</td>
                                                                </tr>";
                                                        }
                                                    }
