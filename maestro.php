                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-5" aria-controls="submenu-5"><i class="fas fa-fw fa-table"></i>Maestro de Materiales</a>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">MAESTRO DE MATERIALES</h2>
                                <section id="formu" style='width:30%'>
                                    <form role="form" action="maestro.php" method="POST">
                        ...
                        <!-- Advanced Tables -->
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Tabla de Maestro de materiales
                                </div>  
                                ...
                                <div class="panel-body">
                                            ...
                                            <tbody>
                                                <?php 
                                                    if($empresa  == "todasempresas"){
                                                        ...
                                                        $posicion = consulta::mmateriales2($fechapri,$fechase,$empresa);
                                                        foreach ($posicion as $row) {
                                                            echo "
                                                                <tr>
                                                                    <td>".$row["empresa"]."</td>  
                                    ...
                                    <?php if ($empresa  == "todasempresas"){ ?>
                                        <form role="form" action="reporte.php" method="POST">
                                            ...
                                            <input type="hidden" value="Maestro de materiales <?php echo $_POST['fecha1'] ?> - <?php echo $_POST['fecha2'] ?>.xls"  name="repor">
                                    ...
                                    <?php };?><?php if ($empresa  != "todasempresas"){ ?>
                                        <form role="form" action="reporte.php" method="POST">
                                            ...
                                            <input type="hidden" value="Maestro de materiales Fecha <?php echo $_POST['fecha1'] ?> - <?php echo $_POST['fecha2'] ?>.xls"  name="repor">
