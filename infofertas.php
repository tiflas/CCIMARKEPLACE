                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-3" aria-controls="submenu-3"><i class="fas fa-fw fa-chart-pie"></i>Cotizaciones</a>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">HISTORIAL OFERTAS</h2>
                                <section id="formu" style='width:30%'>
                                    <form role="form" action="infofertas.php" method="POST">
                                        <label>Nombre Cotizacíon</label>
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"></span>
                                            <input type="text" name="nomcotizacion" class="form-control" required>
                                            <input type="hidden" id="fecha1" class="form-control" value="<?php date_default_timezone_set("America/Bogota") ; echo date("Y-m-d");?>" required>
                                            <input type="hidden" id="fecha2" class="form-control" value="<?php date_default_timezone_set("America/Bogota") ; echo date("Y-m-d");?>" required>
                                        </div>
                        ...
                        <!-- Advanced Tables -->
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Ofertas con total mas bajo
                                </div>  
                                <section style='position:relative;display:none'>
                                    <?php
                                        $uno           = "'%";
                                        $dos           = "%'";
                                        $nomcotizacion = $_POST['nomcotizacion']; 
                                        $nomof         = $uno.$nomcotizacion.$dos; 
                                        $posicion  = consulta::calcularofertas($nomof);
                                ...
                                <div class="panel-body">
                                    ...
                                    <form role="form" action="reporte.php" method="POST">
                                        ...
                                        <input type="hidden" value="<?php echo $_POST['nomcotizacion']; ?>" name="nombreofer">
                                        <input type="hidden" value="<?php echo $nomof ?>"  name="nomoferta">
                                        <input type="hidden" value="Reporte oferta.xls"  name="repor">
