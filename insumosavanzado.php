                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                ...
                                <section id="formu" style='width:30%'>
                                    <form role="form" action="insumosavanzado.php" method="POST">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                            ...
                                            <tbody>
                                                <?php
                                                    if($arti == "'%%'"){
                                                        ...
                                                        $posicion = consulta::consarticulo2($fechapri,$fechase,$arti);
                                    ...
                                    <form role="form" action="reporte2.php" method="POST">
                                        ...
                                        <input type="hidden" value="Reporte articulo integrados <?php echo $articulo; ?>-<?php echo $_POST['fecha1'] ?>-<?php echo $_POST['fecha2'] ?>.xls"  name="repor">
