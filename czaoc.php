                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">COTIZACIÓNES QUE PASARON A OC</h2>
                                <section id="formu" style='width:30%'>
                                    <form role="form" action="czaoc.php" method="POST">
                        ...
                        <!-- Advanced Tables -->
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Tabla de Cotizaciones a Orden de compra
                                </div>  
                                ...
                                <div class="panel-body">
                                    ...
                                    <form role="form" action="reporte.php" method="POST">
                                        ...
                                        <input type="hidden" value="Reporte Cotizaciones pasaron a Ordenes de compra <?php echo $_POST['fecha1'] ?> - <?php echo $_POST['fecha2'] ?>.xls"   name="repor">
