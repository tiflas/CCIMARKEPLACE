                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                ...
                                <section id="formu" style='width:30%'>
                                    <form role="form" action="insumoporproveedor.php" method="POST">
                                        <div style='width:40%'>
                                        ...
                                        <label >Seleccionar Empresa Proveedor</label>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                            ...
                                            <tbody>
                                                <?php
                                                    if(($arti== "'%%'")  ||  ($arti1 == "'%%'")  ||  ($arti2  == "'%%'")  || ($arti3 == "'%%'")){
                                                        ...
                                                        $posicion = consulta::consarticuloproveedor($fechapri,$fechase,$arti,$arti1,$arti2,$arti3,$idempresa);
                                    ...
                                    <form role="form" action="reporte2.php" method="POST">
                                        ...
                                        <input type="hidden" value="Reporte articulo por Proveedor <?php echo $_POST['articulo']; ?> <?php echo $_POST['fecha1'] ?>-<?php echo $_POST['fecha2'] ?>.xls"  name="repor">
