                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">COTIZACIONES</h2>
                                <section id="formu" style='width:30%'>
                                    <form role="form" action="cotizaciones.php" method="POST">
                                ...
                                <div class="panel-body">
                                            ...
                                            <tbody>
                                                <?php
                                                    if($empresa  == "todasempresas"){
                                                        ...
                                                        $posicion = consulta::consczempre($fechapri,$fechase,$empresa);
                                                            foreach ($posicion as $row) {
                                                                echo "
                                                                    <tr>                                                    
                                                                        <td>".$row["empresaCompradora"]."</td>
                                    ...
                                    <?php if ($empresa  == "todasempresas"){ ?>
                                      <form role="form" action="reporte.php" method="POST">
                                          ...
                                          <input type="hidden" value="Reporte CZ <?php echo $_POST['fecha1'] ?> - <?php echo $_POST['fecha2'] ?>.xls"   name="repor">
                                    ...
                                    <?php };?><?php if ($empresa  != "todasempresas"){ ?>
                                      <form role="form" action="reporte.php" method="POST">
                                          ...
                                          <input type="hidden" value="Reporte CZ Fecha <?php echo $_POST['fecha1'] ?> - <?php echo $_POST['fecha2'] ?>.xls"   name="repor">
