                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                ...
                                <section id="abrir" style='position:relative;display:none'>
                                    ...
                                    ?>
                                    <?php 
                                        if($empresa  == ""){ echo "";}else{ echo "<h3>Resultado: Ordenes de Compra  Fecha: $fechapri - $fechase</h3><br> "; }
                                    ?>   
                                </section>
                                <section id="formu" style='width:30%'>
                                    <form role="form" action="oc.php" method="POST">
                                ...
                                <div class="panel-body">
                                            ...
                                            <tbody>
                                                <?php  
                                                    if($empresa  == "todasempresas"){
                                                        ...
                                                        $posicion = consulta::consocempre($fechapri,$fechase,$empresa);
                                                        foreach ($posicion as $row) {
                                                        echo "
                                                            <tr>                                                    
                                                                <td>".$row["idoc"]."</td>
                                    ...
                                    <?php if ($empresa  == "todasempresas"){ ?>
                                        <form role="form" action="reporte.php" method="POST">
                                            ...
                                            <input type="hidden" value="Reporte OC <?php echo $_POST['fecha1'] ?> - <?php echo $_POST['fecha2'] ?>.xls"  name="repor">
                                    ...
                                    <?php };?><?php if ($empresa  != "todasempresas"){ ?>
                                        <form role="form" action="reporte.php" method="POST">
                                            ...
                                            <input type="hidden" value="Reporte OC Fecha <?php echo $_POST['fecha1'] ?> - <?php echo $_POST['fecha2'] ?>.xls"  name="repor">
