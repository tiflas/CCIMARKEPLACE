                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">CZ Y OC Por Codigo Items</h2>
                                <section id="formu" style='width:30%'>
                                    <form role="form" action="infofertaoc.php" method="POST">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form role="form" action="reporte.php" method="POST">
                                        ...
                                        <input type="hidden" value="Reporte CZ Y OC Mincivil <?php echo $_POST['fecha1'] ?>-<?php echo $_POST['fecha2'] ?>.xls"  name="repor">
