    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="inicio.php">ICONSTRUYE</a>
                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">
                            <a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="assets/images/cci.png" alt="" class="user-avatar-md rounded-circle"></a>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-8" aria-controls="submenu-8"><i class="fas fa-fw fa-chart-pie"></i> Graficos</a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-9" aria-controls="submenu-9"><i class="fas fa-fw fa-inbox"></i>Errores Maestrolog</a>
            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                ...
                                <br><h3 class="pageheader-title">ADMINISTRAR PAGINA WEB ICONSTRUYE COLOMBIA</h3>
                    ...
                    <div class="ecommerce-widget">
                                <section id="imagenypdfslider">
                                    <div class="card">
                                        <h5 class="card-header"> Subir Imagen Slider</h5>
                                        <div class="card-body p-0">
                                            <form action="Controller/documentos.controller.php" method="post" enctype="multipart/form-data">
                                                <label>Seleccionar Imagen</label>
                                                <div class="custom-input-file"><input type="file" id="ficheiro" size="1" class="input-file"  name="documentoimagen" onchange="nombreimagen.value = this.value.replace('C:\\fakepath\\', '')"></div><br>
                                                <label>Seleccionar Archivo Pdf</label>
                                                <div class="custom-input-file"><input type="file" id="ficheiro2" size="1" class="input-file"  name="documentopdf" onchange="archivopdf.value = this.value.replace('C:\\fakepath\\', '')"></div>                 
                                                <input type="hidden" id="ficheiro"  name="nombreimagen">
                                                <input type="hidden" id="ficheiro2" name="archivopdf"><br>
                                                <button class="btn" type="botton" name="subirdocu" value="docu"> SUBIR ARCHIVO</button>
                                            </form>
                                        </div>
                                    </div>
                                </section><br>
                                <section id="imagenslider">
                                    <div class="card">
                                        <h5 class="card-header"> Subir Imagen Slider</h5>
                                        <div class="card-body p-0">
                                            <form action="Controller/documentos.controller.php" method="post" enctype="multipart/form-data">
                                                <label>Seleccionar Imagen</label>
                                                <div class="custom-input-file"><input type="file" id="ficheiro" size="1" class="input-file"  name="documentoimagen" onchange="nombreimagen.value = this.value.replace('C:\\fakepath\\', '')"></div>                 
                                                <input type="hidden" id="ficheiro"  name="nombreimagen"><br>
                                                <button class="btn" type="botton" name="subirdocu" value="docu2"> SUBIR ARCHIVO</button>
                                            </form>
                                        </div>
                                    </div>
                                </section><br>
                                <section id="noticiadesypdf">
                                    <div class="card">
                                        <h5 class="card-header"> Noticia Destacada</h5>
                                        <div class="card-body p-0">
                                            <form action="Controller/documentos.controller.php" method="post" enctype="multipart/form-data">
                                                <label>Seleccionar Imagen</label>
                                                <div class="custom-input-file"><input type="file" id="ficheiro" size="1" class="input-file"  name="documentoimagenoti" onchange="imagencli.value = this.value.replace('C:\\fakepath\\', '')"></div><br>
                                                <label>Seleccionar Archivo Pdf</label>
                                                <div class="custom-input-file"><input type="file" id="ficheiro2" size="1" class="input-file"  name="documentopdfnoti" onchange="archivopdfnoti.value = this.value.replace('C:\\fakepath\\', '')"></div>                 
                                                <input type="hidden" id="ficheiro"  name="imagencli">
                                                <input type="hidden" id="ficheiro2" name="archivopdfnoti"><br>
                                                <button class="btn" type="botton" name="subirdocu" value="notides"> SUBIR ARCHIVO</button>
                                            </form>
                                        </div>
                                    </div>
                                </section><br>
                                <section id="noticiadesimg">
                                    <div class="card">
                                        <h5 class="card-header"> Noticia Destacada</h5>
                                        <div class="card-body p-0">
                                            <form action="Controller/documentos.controller.php" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="custom-input-file"><input type="file" id="ficheiro" size="1" class="input-file"  name="documentoimagenoti" onchange="imagencli.value = this.value.replace('C:\\fakepath\\', '')"></div><br>                 
                                                <input type="hidden" id="ficheiro"  name="imagencli">
                                                <button class="btn" type="botton" name="subirdocu" value="notimg2"> SUBIR ARCHIVO</button>
                                            </form>
                                        </div>
                                    </div>
                                </section><br>
