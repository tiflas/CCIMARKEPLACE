                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">ESTADO COTIZACIÓNES </h2>
                                <section id="formu" style='width:30%'>
                                    <form role="form" action="estadocot.php" method="POST">
                                        <label >Seleccionar Estado de Cotización:</label>
                                        <select class='form-control' name='idestado'>
                                            <option value="25">COT Enviada a Compra</option>
                                                <?php
                                                    $empre = consulta::estado();
                                                    foreach ($empre as $row1) {
                                                    echo"<option value='".$row1["IDESTADODOC"]."'>".$row1["DESCRIPCION"]."</option>";
                                                    }
                                                ?>
                                        </select>
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables1">
                                            ...
                                            <tbody>
                                                <?php                                                                                 $posicion = consulta::czestado($fechapri,$fechase,$idestado);
                                    ...
                                    <form role="form" action="reporte.php" method="POST">
                                        ...
                                        <input type="hidden" value="<?php echo $_POST['idestado']?>" name="idestado">
                                        <input type="hidden" value="Reporte estado CZ <?php echo $_POST['fecha1'] ?> - <?php echo $_POST['fecha2'] ?>.xls"   name="repor">
