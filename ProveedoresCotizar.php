                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">PROVEEDORES INVITADOS A COTIZAR</h2>
                                <section id="formu" style='width:30%'>
                                    <form role="form" action="ProveedoresCotizar.php" method="POST">
                                       <label>Numero de Cotización</label>
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"></span>
                                            <input type="text" name="NumCotizacion" class="form-control">
                                        </div>
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables1">
                                            ...
                                            <tbody>
                                                <?php
                                                    if($NumCotizacion == '' and $fechapri == '' and $fechase == ''){
                                                        echo "
                                                            <tr>                                                    
                                                                <td> </td>
                                                                <td> </td>
                                    ...
                                    <form role="form" action="reporte.php" method="POST">
                                        ...
                                        <input type="hidden" value="<?php echo $_POST['NumCotizacion']?>" name="NumCotizacion">
                                        <input type="hidden" value="Reporte Proveedores CZ.xls"   name="repor">
