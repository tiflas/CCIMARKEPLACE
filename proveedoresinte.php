                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-7" aria-controls="submenu-7"><i class="fas fa-fw fa-table"></i>Proveedores no Integrados</a>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">PROVEEDORES NO INTEGRADOS</h2>
                                <section id="formu" style='width:30%'>
                                    <form role="form" action="proveedoresinte.php" method="POST">
                        ...
                        <!-- Advanced Tables -->
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Tabla de Cotizaciones - Proveedores no integrados
                                </div>  
                                ...
                                <div class="panel-body">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables1">
                                            ...
                                            <tbody>
                                                <?php                                                                                 if($empresa  == "todasempresas"){
                                                        ...
                                                        $posicion = consulta::integrados($empresa,$fechapri,$fechase);
                                                        foreach ($posicion as $row) {
                                                            echo "
                                                                <tr>                                                    
                                                                    <td>".$row["empresa"]."</td>
                                    ...
                                    <?php if ($empresa  == "todasempresas"){ ?>
                                      <form role="form" action="reporte.php" method="POST">
                                          ...
                                          <input type="hidden" value="Proveedores integrados-<?php echo $_POST['fecha1'] ?>-<?php echo $_POST['fecha2']?>.xls"   name="repor">
                                    ...
                                    <?php };?><?php if ($empresa  != "todasempresas"){ ?>
                                      <form role="form" action="reporte.php" method="POST">
                                          ...
                                          <input type="hidden" value="Proveedores integrados Fecha-<?php echo $_POST['fecha1'] ?>-<?php echo $_POST['fecha2']?>.xls"   name="repor">
